...
@ObjCClassBinding
public class SVGDocumentView extends UIView {
	static {
		NatJ.register();
	}

	@Generated
	protected SVGDocumentView(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native SVGDocumentView alloc();
	...
	@Generated
	@Selector("init")
	public native SVGDocumentView init();

	@Generated
	@Selector("initWithCoder:")
	public native SVGDocumentView initWithCoder(NSCoder aDecoder);

	@Generated
	@Selector("initWithFrame:")
	public native SVGDocumentView initWithFrame(@ByValue CGRect frame);
